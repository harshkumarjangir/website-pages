        ...
        <section className="w-full bg-white text-gray-800 py-12">
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-10 items-center">
                ...
                <div className="border rounded-lg overflow-hidden shadow-md">
                    {/* Header */}
                    <div className="bg-blue-600 text-white flex items-center gap-3 px-5 py-3">
                    ...
                    <div className="bg-white text-center px-6 py-6">
                        ...
                        <Link
                            ...
                            target="_blank"
                            className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white mt-5 py-2 px-6 rounded-md text-lg font-semibold hover:bg-blue-700 transition-all"
                        >
                            {linkedin.buttonText}
