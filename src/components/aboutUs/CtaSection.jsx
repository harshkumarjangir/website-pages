                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6 px-10 md:px-20 py-14">
                    ...
                    {isDownload ? (
                        <a
                            ...
                            className="flex items-center gap-2 bg-white text-[#0B75FF] font-medium px-8 py-3 rounded-md shadow hover:bg-blue-50 transition"
                        >
                        ...
                        <Link
                            href={buttonLink}
                            className="bg-white text-[#0B75FF] font-medium px-8 py-3 rounded-md shadow hover:bg-blue-50 transition"
                        >
                            {buttonText}
                        </Link>
                    )}
