...
export default function OurExpertise({ data }) {
    ...
    return (
        <section className="relative w-full bg-black text-white py-20 overflow-hidden">
            ...
            <h2 className="absolute top-8 left-1/2 -translate-x-1/2 uppercase max-sm:text-3xl text-[90px] md:text-[150px] font-extrabold text-gray-100 tracking-wider opacity-40 select-none pointer-events-none">
                {bgTitle}
            </h2>
